...
School library tool that allows you to record what books are in the library and who borrows them, the project focused on practicing the main four concepts in oop using ruby.
...
```sh
cd [your-folder] https://github.com/umair-rao/OOP-school-library.git
```
cd my-folder
```sh
...
Feel free to check the [issues page](https://github.com/umair-rao/OOP-school-library/issues).
